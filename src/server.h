...
public:
  SettingsServer(Storage &storageRef, int ledPin) : storage(storageRef)
  {
...
private:
  ...
  void submitRoute()
  {
    ...
    key.toCharArray(newSettings.key, sizeof(newSettings.key) - 1);
